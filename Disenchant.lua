...
local UncommonArmor = {
    {
        ...
        maxlvl = 15,
        shards = {
            {p = 0.80, min = 1, max = 2, id = StrangeDust_Id}, {p = 0.20, min = 1, max = 2, id = LesserMagicEssence_Id},
        },
    }, {
        minlvl = 16,
        maxlvl = 20,
        ...
        maxlvl = 30,
        shards = {
            {p = 0.75, min = 1, max = 2, id = SoulDust_Id}, {p = 0.20, min = 1, max = 2, id = GreaterAstralEssence_Id},
        ...
        maxlvl = 35,
        shards = {
            {p = 0.75, min = 2, max = 5, id = SoulDust_Id}, {p = 0.20, min = 1, max = 2, id = LesserMysticEssence_Id},
        ...
        maxlvl = 45,
        shards = {
            {p = 0.75, min = 2, max = 5, id = VisionDust_Id}, {p = 0.20, min = 1, max = 2, id = LesserNetherEssence_Id},
        ...
        maxlvl = 50,
        shards = {
            {p = 0.75, min = 1, max = 2, id = DreamDust_Id}, {p = 0.20, min = 1, max = 2, id = GreaterNetherEssence_Id},
        ...
        maxlvl = 55,
        shards = {
            {p = 0.75, min = 2, max = 5, id = DreamDust_Id}, {p = 0.20, min = 1, max = 2, id = LesserEternalEssence_Id},
        ...
        maxlvl = 80,
        shards = {
            {p = 0.75, min = 1, max = 2, id = ArcaneDust_Id}, {p = 0.22, min = 1, max = 2, id = LesserPlanarEssence_Id},
        ...
        maxlvl = 100,
        shards = {
            {p = 0.75, min = 2, max = 3, id = ArcaneDust_Id}, {p = 0.22, min = 2, max = 3, id = LesserPlanarEssence_Id},
            {p = 0.03, min = 1, max = 1, id = SmallPrismaticShard_Id},
        },
    }, {
        minlvl = 101,
        ...
        maxlvl = 380,
        shards = {
            {p = 0.85, min = 1, max = 3, id = SpiritDust_Id}, {p = 0.15, min = 1, max = 1, id = MysteriousEssence_Id},
        },
    }, {
        minlvl = 381,
        maxlvl = 390,
        shards = {
            {p = 0.85, min = 1, max = 4, id = SpiritDust_Id}, {p = 0.15, min = 1, max = 1, id = MysteriousEssence_Id},
        },
    }, {
        minlvl = 391,
        maxlvl = 410,
        shards = {
            {p = 0.85, min = 1, max = 5, id = SpiritDust_Id}, {p = 0.15, min = 1, max = 2, id = MysteriousEssence_Id},
        },
    }, {
        minlvl = 411,
        maxlvl = 450,
        shards = {
            {p = 0.85, min = 1, max = 6, id = SpiritDust_Id}, {p = 0.15, min = 1, max = 3, id = MysteriousEssence_Id},
        },
    },
}
...
local UncommonWeapon = {
    {
        ...
        maxlvl = 15,
        shards = {
            {p = 0.80, min = 1, max = 2, id = LesserMagicEssence_Id}, {p = 0.20, min = 1, max = 2, id = StrangeDust_Id},
        },
    }, {
        minlvl = 16,
        maxlvl = 20,
        ...
        maxlvl = 30,
        shards = {
            {p = 0.75, min = 1, max = 2, id = GreaterAstralEssence_Id}, {p = 0.20, min = 1, max = 2, id = SoulDust_Id},
            {p = 0.05, min = 1, max = 1, id = LargeGlimmeringShard_Id},
        },
    }, {
        minlvl = 31,
        maxlvl = 35,
        shards = {
            {p = 0.75, min = 1, max = 2, id = LesserMysticEssence_Id}, {p = 0.20, min = 2, max = 5, id = SoulDust_Id},
            {p = 0.05, min = 1, max = 1, id = SmallGlowingShard_Id},
        },
    }, {
        minlvl = 36,
        ...
        shards = {
            ...
            {p = 0.20, min = 1, max = 2, id = VisionDust_Id}, {p = 0.05, min = 1, max = 1, id = LargeGlowingShard_Id},
        },
    }, {
        minlvl = 41,
        maxlvl = 45,
        shards = {
            {p = 0.75, min = 1, max = 2, id = LesserNetherEssence_Id}, {p = 0.20, min = 2, max = 5, id = VisionDust_Id},
            {p = 0.05, min = 1, max = 1, id = SmallRadiantShard_Id},
        },
    }, {
        minlvl = 46,
        maxlvl = 50,
        shards = {
            {p = 0.75, min = 1, max = 2, id = GreaterNetherEssence_Id}, {p = 0.20, min = 1, max = 2, id = DreamDust_Id},
            {p = 0.05, min = 1, max = 1, id = LargeRadiantShard_Id},
        },
    }, {
        minlvl = 51,
        maxlvl = 55,
        shards = {
            {p = 0.75, min = 1, max = 2, id = LesserEternalEssence_Id}, {p = 0.22, min = 2, max = 5, id = DreamDust_Id},
        ...
        maxlvl = 100,
        shards = {
            {p = 0.75, min = 2, max = 3, id = LesserPlanarEssence_Id}, {p = 0.22, min = 2, max = 3, id = ArcaneDust_Id},
            {p = 0.03, min = 1, max = 1, id = SmallPrismaticShard_Id},
        },
    }, {
        minlvl = 101,
        ...
        shards = {
            ...
            {p = 0.22, min = 2, max = 5, id = ArcaneDust_Id}, {p = 0.03, min = 1, max = 1, id = LargePrismaticShard_Id},
        },
    }, {
        minlvl = 130,
        maxlvl = 151,
        shards = {
            ...
            {p = 0.22, min = 1, max = 3, id = InfiniteDust_Id}, {p = 0.03, min = 1, max = 1, id = SmallDreamShard_Id},
        },
    }, {
        minlvl = 152,
        maxlvl = 187,
        shards = {
            ...
            {p = 0.22, min = 2, max = 7, id = InfiniteDust_Id}, {p = 0.03, min = 1, max = 1, id = DreamShard_Id},
        },
    }, {
        minlvl = 272,
        maxlvl = 275,
        ...
        maxlvl = 390,
        shards = {
            {p = 0.85, min = 1, max = 5, id = SpiritDust_Id}, {p = 0.15, min = 1, max = 1, id = MysteriousEssence_Id},
        },
    }, {
        minlvl = 391,
        maxlvl = 410,
        shards = {
            {p = 0.85, min = 1, max = 6, id = SpiritDust_Id}, {p = 0.15, min = 1, max = 2, id = MysteriousEssence_Id},
        },
    }, {
        minlvl = 411,
        maxlvl = 450,
        shards = {
            {p = 0.85, min = 1, max = 7, id = SpiritDust_Id}, {p = 0.15, min = 1, max = 3, id = MysteriousEssence_Id},
        },
    },
}

local Rare = {
    {minlvl = 11, maxlvl = 25, shards = {{p = 1.00, min = 1, max = 1, id = SmallGlimmeringShard_Id}}},
    {minlvl = 26, maxlvl = 30, shards = {{p = 1.00, min = 1, max = 1, id = LargeGlimmeringShard_Id}}},
    {minlvl = 31, maxlvl = 35, shards = {{p = 1.00, min = 1, max = 1, id = SmallGlowingShard_Id}}},
    {minlvl = 36, maxlvl = 40, shards = {{p = 1.00, min = 1, max = 1, id = LargeGlowingShard_Id}}},
    {minlvl = 41, maxlvl = 45, shards = {{p = 1.00, min = 1, max = 1, id = SmallRadiantShard_Id}}},
    {minlvl = 46, maxlvl = 50, shards = {{p = 1.00, min = 1, max = 1, id = LargeRadiantShard_Id}}},
    {minlvl = 51, maxlvl = 55, shards = {{p = 1.00, min = 1, max = 1, id = SmallBrilliantShard_Id}}}, {
        minlvl = 56,
        maxlvl = 65,
        shards = {
        ...
        maxlvl = 166,
        shards = {
            {p = 0.995, min = 1, max = 1, id = SmallDreamShard_Id}, {p = 0.005, min = 1, max = 1, id = AbyssCrystal_Id},
        },
    }, {
        minlvl = 167,
        maxlvl = 200,
        shards = {
            {p = 0.995, min = 1, max = 1, id = DreamShard_Id}, {p = 0.005, min = 1, max = 1, id = AbyssCrystal_Id},
        },
    }, {minlvl = 201, maxlvl = 316, shards = {{p = 1, min = 1, max = 1, id = SmallHeavenlyShard_Id}}},
    {minlvl = 317, maxlvl = 380, shards = {{p = 1, min = 1, max = 1, id = HeavenlyShard_Id}}},
    {minlvl = 381, maxlvl = 424, shards = {{p = 1, min = 1, max = 1, id = SmallEtherealShard_Id}}},
    {minlvl = 425, maxlvl = 449, shards = {{p = 1, min = 1, max = 1, id = EtherealShard_Id}}}, {
        minlvl = 449,
        maxlvl = 450,
        shards = {
            {p = 0.8, min = 1, max = 1, id = SmallEtherealShard_Id}, {p = 0.2, min = 1, max = 1, id = EtherealShard_Id},
        },
    }, {minlvl = 451, maxlvl = 500, shards = {{p = 1, min = 1, max = 1, id = EtherealShard_Id}}},
}

local Epic = {
    {minlvl = 40, maxlvl = 45, shards = {{p = 1.00, min = 2, max = 4, id = SmallRadiantShard_Id}}},
    {minlvl = 46, maxlvl = 50, shards = {{p = 1.00, min = 2, max = 4, id = LargeRadiantShard_Id}}},
    {minlvl = 51, maxlvl = 55, shards = {{p = 1.00, min = 2, max = 4, id = SmallBrilliantShard_Id}}},
    {minlvl = 56, maxlvl = 60, shards = {{p = 1.00, min = 1, max = 1, id = NexusCrystal_Id}}},
    {minlvl = 61, maxlvl = 94, shards = {{p = 1.00, min = 1, max = 2, id = NexusCrystal_Id}}},
    {minlvl = 95, maxlvl = 165, shards = {{p = 1.00, min = 1, max = 2, id = VoidCrystal_Id}}},
    {minlvl = 200, maxlvl = 277, shards = {{p = 1.00, min = 1, max = 1, id = AbyssCrystal_Id}}},
    {minlvl = 278, maxlvl = 419, shards = {{p = 1.00, min = 1, max = 1, id = MaelstromCrystal_Id}}},
    {minlvl = 420, maxlvl = 600, shards = {{p = 1.00, min = 1, max = 1, id = ShaCrystal_Id}}},
}
...
local Qualities = {ITEM_QUALITY_UNCOMMON, ITEM_QUALITY_RARE, ITEM_QUALITY_EPIC}

local Types = {ITEM_TYPE_ARMOR, ITEM_TYPE_WEAPON}

-- This table collects the raw data above.
local DisenchantInfo = {
    [ITEM_QUALITY_UNCOMMON] = {[ITEM_TYPE_ARMOR] = UncommonArmor, [ITEM_TYPE_WEAPON] = UncommonWeapon},
    [ITEM_QUALITY_RARE] = {[ITEM_TYPE_ARMOR] = Rare, [ITEM_TYPE_WEAPON] = Rare},
    [ITEM_QUALITY_EPIC] = {[ITEM_TYPE_ARMOR] = Epic, [ITEM_TYPE_WEAPON] = Epic},
}
...
function AuctionLite:GetDisenchantValue(item)
    ...
    local disenchantable = quality == ITEM_QUALITY_UNCOMMON or quality == ITEM_QUALITY_RARE or quality ==
                               ITEM_QUALITY_EPIC
