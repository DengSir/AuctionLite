...
local Options = {
    type = 'group',
    get = function(item)
        return AuctionLite.db.profile[item[#item]]
    end,
    set = function(item, value)
        AuctionLite.db.profile[item[#item]] = value
    end,
    args = {
        storePrices = {
            type = 'toggle',
...
local SellOptions = {
    ...
    args = {
        ...
        defaultStacks = {
            ...
            style = 'dropdown',
            values = {a_one = L['One Stack'], b_full = L['Max Stacks'], c_excess = L['Max Stacks + Excess']},
            order = 7,
        },
        defaultSize = {
            type = 'select',
            ...
            style = 'dropdown',
            values = {a_one = L['One Item'], b_stack = L['Selected Stack Size'], c_full = L['Full Stack']},
            order = 8,
        },
        printPriceData = {
            type = 'toggle',
...
local YesNoMaybe = {a_yes = L['Always'], b_maybe = L['If Applicable'], c_no = L['Never']}
...
local TooltipOptions = {
    ...
    args = {
        ...
        blankVendor = {type = 'description', name = '', desc = '', order = 2},
        showDisenchant = {
            type = 'select',
        ...
        blankDisenchant = {type = 'description', name = '', desc = '', order = 4},
        showAuction = {
            type = 'select',
        ...
        blankAuction = {type = 'description', name = '', desc = '', order = 6},
        tooltipLocation = {
            type = 'select',
        ...
        blankLocation = {type = 'description', name = '', desc = '', order = 8},
        blank = {type = 'description', name = ' ', desc = ' ', order = 9},
        coinTooltips = {
            type = 'toggle',
...
local SlashCmds = {'al', 'auctionlite'}

local Defaults = {
    factionrealm = {prices = {}, prefs = {}},
    profile = {
        method = 1,
        duration = 3,
        bidUndercut = 0.25,
